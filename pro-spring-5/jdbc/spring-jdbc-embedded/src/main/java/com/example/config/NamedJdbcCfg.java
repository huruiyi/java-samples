...
import com.example.dao.JdbcSingerDao;
import com.example.dao.SingerDao;
import com.example.tools.CleanUp;
...
public class NamedJdbcCfg {
    ...
    public DataSource dataSource() {
        try {
            ...
            return dbBuilder.setType(EmbeddedDatabaseType.H2).addScripts("classpath:db/x2/schema.sql", "classpath:db/x2/test-data.sql").build();
        } catch (Exception e) {
