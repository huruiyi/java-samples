...
public class SearchController {
  ...
  public List<ProductDocument> getAll() {
    ...
    list.sort((m, n) -> m.getId().compareTo(n.getId()));
    return list;
  }
  ...
  /**
   * 搜索，命中关键字高亮 http://localhost:9001/query_hit?keyword=无印良品荣耀&indexName=orders&fields=productName,productDesc
   *
   * @param keyword   关键字
  ...
  /**
   * 搜索，命中关键字高亮 http://localhost:9001/query_hit_page?keyword=无印良品荣耀&indexName=orders&fields=productName,productDesc&pageNo=1&pageSize=1
   *
   * @param pageNo    当前页
