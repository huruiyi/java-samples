...
public class SingerHandlerTest {
  ...
  public void getAll() throws Exception {
    this.testClient.get().uri("/").accept(MediaType.TEXT_EVENT_STREAM).exchange().expectStatus().isOk().expectHeader()
        .contentType(MediaType.APPLICATION_JSON).expectBodyList(Singer.class).hasSize(14).consumeWith(Assertions::assertNotNull);
  }
