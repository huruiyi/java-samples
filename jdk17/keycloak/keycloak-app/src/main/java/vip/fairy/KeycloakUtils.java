...
public class KeycloakUtils {
  ...
  static Keycloak getKeycloakInstanceBuAdminAccount() {
    return KeycloakBuilder.builder()
        .serverUrl(KeycloakConstants.serverUrl)
        .realm(KeycloakConstants.realm)
        .clientId(KeycloakConstants.clientId)
  ...
  /**
   * 客户端需要 manage-users 或 view-users 小权限。建议创建专用客户端并分配最小权限。
  ...
  public static Keycloak getKeycloakInstanceByServiceAccount() {
    return KeycloakBuilder.builder()
        ...
        .realm(KeycloakConstants.realm)
        .clientId(KeycloakConstants.clientId)
        .clientSecret(KeycloakConstants.clientSecret)
