...
public class ReactiveSalaryServiceLiveTest {
    ...
    public void shouldCreateAndRetrieveSalary() {
        ...
        //when
        ResponseEntity<SalaryDto> response = restTemplate.postForEntity("http://localhost:8080/salary", entity, SalaryDto.class);
        ...
        String url = "http://localhost:8080/salary/" + response.getBody().getUserId();
