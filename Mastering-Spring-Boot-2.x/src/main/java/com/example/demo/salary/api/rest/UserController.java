package com.example.demo.salary.api.rest;

import com.example.demo.chapter_2.domain.SalaryAndUser;
import com.example.demo.chapter_2.domain.User;
import com.example.demo.chapter_2.domain.UserDto;
import com.example.demo.salary.api.UserService;
import com.example.demo.salary.infrastructure.exceptions.UserNotFoundException;
