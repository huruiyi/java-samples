...
public class RestTemplateConfiguration {
    ...
    public RequestConfig requestConfig(int connectionTimeout, int socketTimeout) {
        return RequestConfig.custom().setConnectionRequestTimeout(1000)
                //how long wait for a connection from connection manager
                .setConnectTimeout(connectionTimeout)
                //how long wait for establishing connection
    ...
    public RestTemplate restTemplateFacebook() {
        PoolingHttpClientConnectionManager poolingHttpClientConnectionManager = poolingHttpClientConnectionManager(100, 100);
