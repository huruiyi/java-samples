...
public class GoogleBarCodeUtils {
   ...
   * @author myc
   */
  public static BufferedImage insertWords(BufferedImage image, String equipNo) {
...
//            int wordStartX=(WIDTH - strWidth) / 2;
  ...
  private static void setDrawRectDottedLine(Graphics2D g2d) {
    ...
    BasicStroke stroke = new BasicStroke(0.5f, BasicStroke.CAP_ROUND, BasicStroke.JOIN_ROUND, 0.5f, new float[]{1, 4}, 0.5f);
