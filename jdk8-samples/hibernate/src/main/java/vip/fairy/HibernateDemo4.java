...
import vip.fairy.entities.Customer6;
...
public class HibernateDemo4 {
  ...
  public void demo1() {
    ...
    session.get(Customer1.class, id);
    transaction.commit();
    session.close();
  ...
  public void demo2() {
    ...
    Customer1 customer1 = session.get(Customer1.class, 1L);
    System.out.println(customer1);

    Customer1 customer2 = session.get(Customer1.class, 1L);
